...
const LoanData = () => {
    ...
    const showData=async()=>{
        try{
    const res=await fetch(`${BaseUrl}/loan?page=1`,{
        method:"GET",
        headers:{
  ...
  const deleteLoanData=async()=>{
    try{
        const res=await fetch(`${BaseUrl}/loan/${open.id}`,{
            method:"DELETE",
            headers:{
                "Content-Type":"application/json",
            }
  ...
  const fetchLoanData = async (currentPage) => {
    try{
      const res=await fetch(`${BaseUrl}/loan?page=${currentPage}`,{
        method:"GET",
        headers:{
            "Content-Type":"application/json",
        },
...
if(res.status===400 || !data){
  ...
  >
    ...
    <DialogActions>
      ...
      <Button onClick={deleteLoanData} autoFocus>
        Yes
      </Button>
    </DialogActions>
  </Dialog> 
        ...
        <div className="content-wrapper">
          ...
          <div className="col-lg-12 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Loan Queries</h4>
          ...
          <button className='btn btn-sm' title="Delete Record" style={{backgroundColor:"white"}}  onClick={() => {
        ...
        <div className="col-md-12">
            ...
            <div className="col-md-12">
            <div className="form-group">
              <label htmlFor="contact">Recipient Email Id</label>
              <input
                type="email"
                className="form-control"
        ...
        nextLabel={"next"}
        breakLabel={"..."}
        pageCount={loanData.numberofPage}
