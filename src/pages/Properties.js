                  ...
                  <Modal show={show} onHide={handleClose} backdrop="static"
                    ...
                    <Modal.Body>
                      <form className="forms-sample">
                        ...
                        <div className="row">
                          <h4 class="text-divider"><span>Amenities</span></h4>
                        ...
                        <div className="row">
                          <h4 class="text-divider"><span>Rating</span></h4>
                        ...
                        <div className="row">
                          <h4 class="text-divider"><span>Description</span></h4>
                        ...
                        <div className="row">
                          <h4 class="text-divider"><span>Address Details</span></h4>
                          {/* <h4 style={{color:"	#4d0000",textAlign:"center"}}>Address Details</h4> */}
                          <div className="col-md-6">
                            <div className="form-group">
                        ...
                        <div class="row">
                          <h4 class="text-divider"><span>Images</span></h4>
                          <div className="col-md-6">
                            <div className="form-group">
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td><div className='content'>
                                  <Button className='btn btn-sm' style={{ backgroundColor: "white" }} onClick={() => { updateProperty(data._id) }}><i className="fas fa-edit"></i></Button>
